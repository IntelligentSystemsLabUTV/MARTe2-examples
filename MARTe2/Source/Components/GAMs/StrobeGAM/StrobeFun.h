/**
 * @file StrobeFun.h
 * @brief Header file for class StrobeFun
 * @date 19/05/2017
 ...
 * @details This header file contains the declaration of the class StrobeFun
