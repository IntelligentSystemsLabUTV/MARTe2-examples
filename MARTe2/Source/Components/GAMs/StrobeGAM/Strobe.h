/**
 * @file Strobe.h
 * @brief Header file for class Strobe
 * @date 19/05/2017
 ...
 * @details This header file contains the declaration of the class Strobe
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef StrobeGENERATOR_Strobe_H_
#define StrobeGENERATOR_Strobe_H_
...
/**
 * @brief Generic class to implement any kind of Strobe
 * @details This class contains the generic common functions and variables to implement any Strobe signal.
 *
...
public:
     ...
     * will be on with the expected defined Strobe.
    ...
    /**
     * @brief Generic implementation of the Strobe.
...
protected:
    ...
    /**
     * @brief Accelerates (if needed) the calculation of the Strobe so that when many output signals share the same Strobe this only has to be performed once.
     ...
     * @return true if the Strobe value was correctly computed.
     */
    ...
    /**
     * Holds the Strobe outputs before being cast to a specific type
     */
    ...
    /**
     * Indicates if the trigger mechanism is enabled. If it is disabled the Strobe generated will be connected to the
     ...
     * @details This function decides if the triggersON is enabled allowing to output the Strobe generated.
     */
