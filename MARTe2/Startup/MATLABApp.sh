...
# MATLAB Models
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MATLAB_Examples_DIR/Models/Gain
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MATLAB_Examples_DIR/Models/PID
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MATLAB_Examples_DIR/Models/StateSpace
# MDSplus
